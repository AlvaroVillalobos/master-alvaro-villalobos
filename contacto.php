...
?>
    ...
    <h2>EJERCICIO CSS no repeat</h2>
    <div class="imagen-no-repeat"></div>
    <h2>Voy a poner aquí el calendario del curso para tenerlo a mano</h2>
    <div>
     ...
     <img src="/imagenes/calendario-2026.png" alt="Calendario del máster SEO 1" width="1000" height="500">
      ...
      <div><p>Y aquí voy a meter otra <b style="color: rgb(211, 11, 64);">imagen chulísima</b> para aprovechar los espacios entre párrafos.</p>
      <p>Esta es la imagen chulísima:</p>
      <image>
      <img src="imagenes/la-mula-chula.jpeg">
      </image>
      <div>
      <iframe
